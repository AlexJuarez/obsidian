...
define(function(require) {
    ...
    app.controller('placementsHeader', [
        '$scope', '$modal', '$rootScope', '$q', 'placements',
        function($scope, $modal, $rootScope, $q, placements) {
            ...
            function pullTags() {
                var placements = placements.getSelectedPlacementIds();
                var tags = '';

                placements.forEach(function(placement) {
                    //TODO: grab ad tags, stick in tags string, download tags
                });
            }
